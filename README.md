...
-  En una primera instancia, cuando no exista ninguna dieta, deberás pre-cargar la base de datos con las dietas de la [**documentación**](https://spoonacular.com/food-api/docs#Diets).
...
-  Botones/Opciones para **ordenar** de forma tanto ascendente como descendente las recetas por orden alfabético y por "comida saludable" (_health score_).
...
**⚠️ IMPORTANTE**: se deben mostrar tanto las recetas traídas desde la API como así también las de la base de datos, pero **NO** está permitido almacenar en la base de datos las recetas de la API. **Solamente se pueden guardar aquellas creadas desde el form**.
